      ...
      <div className="container">
        <div className="about-content">
          <div className="about-text">
            ...
            <p>Our team uses eco-friendly cleaning solutions and equipment to ensure your windows sparkle and your surfaces shine. Whether it's a residential home or commercial property, we treat every job with the same level of care and professionalism.</p>
